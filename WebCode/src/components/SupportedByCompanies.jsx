      ...
      <div className="container mx-auto px-4">
        <div className="text-center">
          ...
          <div className="flex flex-wrap justify-center font-bold items-center gap-6">
            ...
            <span className="text-gray-400 text-lg">agency</span>
            <span className="text-gray-400  gap-1 text-lg flex">
              <span className='mt-2'>
              <FaCloud />
              </span> 
              application
            </span>
            <span className="text-gray-400 text-lg">business</span>
            <span className="text-gray-400 text-lg">company</span>
            <span className="text-gray-400  gap-1 text-lg flex">
              <span className='mt-2'>
              <SiAwsorganizations />
              </span> 
            ...
            <span className="text-gray-400 text-lg">venture</span>
          </div>
        </div>
      </div>
    </div>
